      ...
      <DialogContent className="max-w-4xl lg:max-w-5xl xl:max-w-6xl max-h-[90vh] overflow-y-auto p-0">
        <DialogHeader className="p-4 sm:p-6 lg:p-6 border-b">
          <div className="flex items-start justify-between pb-2">
            <DialogTitle className="text-xl sm:text-2xl lg:text-3xl font-bold line-clamp-2 mr-4">{product.name}</DialogTitle>
            <DialogClose asChild>
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8">
            ...
            <div className="space-y-6 lg:col-span-3">
              ...
              {/* Description */}
              <div>
                <h4 className="font-semibold text-base sm:text-lg mb-2">Description</h4>
              ...
              {product.specifications && Object.keys(product.specifications).length > 0 && (
                <div>
                  <h4 className="font-semibold text-base sm:text-lg mb-3">Specifications</h4>
